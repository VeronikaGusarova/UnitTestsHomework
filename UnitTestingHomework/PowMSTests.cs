    ...
    public class PowMSTests:BaseTest
    {
        ...
        public void PowIntNumbersTest()
        {
            ...
            foreach (var num in pairs)
                Assert.AreEqual(calculator.Pow(num.Item1, num.Item2), Math.Pow(num.Item1, num.Item2));
        }
        ...
        public void PowFloatNumbersTest()
        {
            ...
            foreach (var num in pairs)
                Assert.AreEqual(calculator.Pow(num.Item1, num.Item2), Math.Pow(Convert.ToDouble(num.Item1), Convert.ToDouble(num.Item2)));
        }
        ...
        public void PowMixedNumbersTest()
        {
            ...
            foreach (var num in pairs)
                Assert.AreEqual(calculator.Pow(num.Item1, num.Item2), Math.Pow(Convert.ToDouble(num.Item1), num.Item2));
        }
        ...
        public void PowMixedNumbersTest2()
        {
            ...
            foreach (var num in pairs)
                Assert.AreEqual(calculator.Pow(num.Item1, num.Item2), Math.Pow(num.Item1, Convert.ToDouble(num.Item2)));
        }
