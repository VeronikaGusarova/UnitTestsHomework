    ...
    public class SubMSTests:BaseTest
    {
        ...
        public void SubIntNumbersTest()
        {
            ...
            foreach (var num in pairs)
                Assert.AreEqual(calculator.Sub(num.Item1, num.Item2), num.Item1 - num.Item2);
        }
        ...
        public void SubStringNumbersTest()
        {
            ...
            foreach (var num in pairs)
                Assert.AreEqual(calculator.Sub(num.Item1, num.Item2), Convert.ToDouble(num.Item1) - Convert.ToDouble(num.Item2));
        }
